...
public class Kafka_Streams_TensorFlow_Image_Recognition_Example_IntegrationTest {
	...
	public void shouldRecognizeImages() throws Exception {
		...
		List<String> inputValues = Arrays.asList("src/main/resources/TensorFlow_Images/trained_airplane_2.jpg",
				...
				"src/main/resources/TensorFlow_Images/trained_butterfly.jpg", "src/main/resources/TensorFlow_Images/0.jpg", "src/main/resources/TensorFlow_Images/1.jpg", "src/main/resources/TensorFlow_Images/2.jpg", "src/main/resources/TensorFlow_Images/3.jpg");
